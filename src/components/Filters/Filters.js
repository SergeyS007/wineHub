...
import FiltersCardList from "../FiltersCardList/FiltersCardList";
...
const Filters = () => {
  ...
  const winesList = useSelector(getWines);
  ...
  // }
  const showWineList = winesList.slice((page - 1) * 3, page * 3);
  ...
  function handleShowMore() {
    let maxPage = findMaxPage(winesList.length, 3);
    if (page < maxPage) {
